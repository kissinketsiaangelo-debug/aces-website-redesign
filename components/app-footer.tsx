    ...
    <footer className="mt-auto border-t border-border bg-navy text-navy-foreground">
      <div className="mx-auto flex max-w-md flex-col gap-5 px-4 py-6">
        <Link href="/" className="flex items-center gap-2">
          <span className="flex size-8 shrink-0 items-center justify-center rounded-lg bg-white/10 text-sm font-black tracking-tight">
            A
          </span>
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/gallery" className="ml-auto text-[10px] font-semibold text-navy-foreground/70 hover:text-navy-foreground transition-colors">
            ACES Gallery
          </Link>
        </div>
