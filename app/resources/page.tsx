  ...
  return (
    <AppShell title="Resources">
      <section className="px-4 pt-6">
        <h1 className="font-heading text-2xl font-bold text-navy text-balance">Everything you need to excel</h1>
            ...
            >
              ...
              <span className="min-w-0 flex-1">
                <span className="flex items-center justify-between">
                  <span className="font-heading text-base font-bold text-navy">{hub.label}</span>
      ...
      <section className="px-4 pt-6 pb-8">
        <div className="flex items-start gap-3 rounded-3xl bg-secondary/60 p-5">
          ...
          <div>
            <h2 className="font-heading text-sm font-bold text-navy">Prep AI study assistant</h2>
