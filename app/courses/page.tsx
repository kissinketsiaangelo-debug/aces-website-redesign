  ...
  return (
    <AppShell title="Courses">
      <section className="px-4 pt-5">
        <h1 className="font-heading text-2xl font-bold text-navy text-balance">Course materials</h1>
      ...
      {visible.length > 0 ? (
        ...
        <section className="flex flex-col items-center px-6 pt-6 pb-10 text-center" aria-label="No courses available">
          ...
          />
          <h2 className="mt-4 font-heading text-lg font-bold text-navy">No course materials here yet</h2>
