...
export const products: Product[] = [
  ...
  // ── Fashion & Apparel (10) ──
  { id: 'a1', slug: 'custom-crewneck', name: 'Custom Crewneck Sweatshirt', description: 'Comfortable unisex crewneck with custom ACES-inspired embroidery. Perfect for cool evenings on campus.', price: 85, images: img('custom-crewneck'), category: 'fashion-apparel', vendor: { name: S, phone: '050 321 7890', email: 'stylelab@aces.edu' }, createdAt: '2026-01-12', stock: 12, sizing: [{ label: 'S', inStock: true }, { label: 'M', inStock: true }, { label: 'L', inStock: true }, { label: 'XL', inStock: false }], colors: [{ name: 'Navy', hex: '#1B2A4A', images: img('custom-crewneck') }, { name: 'Grey', hex: '#6B7280', images: img('custom-crewneck') }] },
  { id: 'a2', slug: 'denim-jacket', name: 'Denim Jacket', description: 'Classic blue denim jacket with a modern slim fit. Features embroidered patches you can swap.', price: 120, images: img('denim-jacket'), category: 'fashion-apparel', vendor: { name: U, phone: '053 456 7890', email: 'urban.threads@aces.edu' }, createdAt: '2026-01-20', stock: 8, sizing: [{ label: 'S', inStock: true }, { label: 'M', inStock: true }, { label: 'L', inStock: true }, { label: 'XL', inStock: true }] },
  { id: 'a3', slug: 'streetwear-tee', name: 'Streetwear Graphic Tee', description: 'Bold graphic print t-shirt with oversized fit. 100% organic cotton. Multiple colourways available.', price: 45, images: img('streetwear-tee'), category: 'fashion-apparel', vendor: { name: S, phone: '050 321 7890', email: 'stylelab@aces.edu' }, createdAt: '2026-02-08', stock: 25, sizing: [{ label: 'S', inStock: true }, { label: 'M', inStock: true }, { label: 'L', inStock: true }, { label: 'XL', inStock: true }], colors: [{ name: 'Black', hex: '#111111', images: img('streetwear-tee') }, { name: 'White', hex: '#F5F5F5', images: img('streetwear-tee') }] },
  { id: 'a4', slug: 'baseball-cap', name: 'Baseball Cap', description: 'Adjustable dad-cap style with embroidered engineering-themed patch. One size fits most.', price: 30, images: img('baseball-cap'), category: 'fashion-apparel', vendor: { name: U, phone: '053 456 7890', email: 'urban.threads@aces.edu' }, createdAt: '2026-02-15', stock: 20 },
  { id: 'a5', slug: 'canvas-tote-bag', name: 'Canvas Tote Bag', description: 'Heavy-duty canvas tote with reinforced stitching. Big enough for a laptop and textbooks.', price: 35, images: img('tote-bag'), category: 'fashion-apparel', vendor: { name: S, phone: '050 321 7890', email: 'stylelab@aces.edu' }, createdAt: '2026-02-22', stock: 18 },
  { id: 'a6', slug: 'sneaker-set', name: 'Sneaker Care Set', description: 'Clean and protect your kicks with this kit: shoe cleaner, brush, and waterproof spray.', price: 50, images: img('sneaker-care'), category: 'fashion-apparel', vendor: { name: U, phone: '053 456 7890', email: 'urban.threads@aces.edu' }, createdAt: '2026-03-02', stock: 15 },
  { id: 'a7', slug: 'pullover-hoodie', name: 'Pullover Hoodie', description: 'Ultra-soft fleece pullover with kangaroo pocket and adjustable drawstring hood. Your go-to campus layer.', price: 75, images: img('pullover-hoodie'), category: 'fashion-apparel', vendor: { name: S, phone: '050 321 7890', email: 'stylelab@aces.edu' }, createdAt: '2026-03-08', stock: 14, sizing: [{ label: 'S', inStock: true }, { label: 'M', inStock: true }, { label: 'L', inStock: true }, { label: 'XL', inStock: false }], colors: [{ name: 'Black', hex: '#111111', images: img('pullover-hoodie') }, { name: 'Grey', hex: '#9CA3AF', images: img('pullover-hoodie') }] },
  { id: 'a8', slug: 'bucket-hat', name: 'Bucket Hat', description: 'Trendy bucket hat in neutral tones. Reversible design — two looks in one.', price: 25, images: img('bucket-hat'), category: 'fashion-apparel', vendor: { name: U, phone: '053 456 7890', email: 'urban.threads@aces.edu' }, createdAt: '2026-03-15', stock: 22 },
  { id: 'a9', slug: 'phone-pouch', name: 'Crossbody Phone Pouch', description: 'Compact vegan-leather pouch that fits your phone, cards, and keys. Hands-free campus carry.', price: 32, images: img('phone-pouch'), category: 'fashion-apparel', vendor: { name: S, phone: '050 321 7890', email: 'stylelab@aces.edu' }, createdAt: '2026-03-22', stock: 16 },
  { id: 'a10', slug: 'wristband-pack', name: 'Wristband Pack', description: 'Pack of 6 silicone wristbands with motivational tech quotes. Give one to your study buddy.', price: 12, images: img('wristband-pack'), category: 'fashion-apparel', vendor: { name: U, phone: '053 456 7890', email: 'urban.threads@aces.edu' }, createdAt: '2026-04-01', stock: 35 },

  // ── Technology & Electronics (10) ──
  { id: 't1', slug: 'wireless-earbuds', name: 'Wireless Earbuds', description: 'Bluetooth 5.3 earbuds with noise isolation, 24-hour battery life, and IPX5 water resistance.', price: 95, images: img('wireless-earbuds'), category: 'tech-electronics', vendor: { name: T, phone: '020 456 7890', email: 'techconnect@aces.edu' }, createdAt: '2026-01-10', stock: 18, colors: [{ name: 'White', hex: '#F5F5F5', images: img('wireless-earbuds') }, { name: 'Black', hex: '#111111', images: img('wireless-earbuds') }] },
  { id: 't2', slug: 'power-bank-20000', name: 'Power Bank 20000mAh', description: 'High-capacity power bank with dual USB-A and USB-C output. Charges a laptop once and a phone 5 times.', price: 80, images: img('power-bank'), category: 'tech-electronics', vendor: { name: GU, phone: '024 567 8901', email: 'gadgetguru@aces.edu' }, createdAt: '2026-01-25', stock: 10 },
  { id: 't3', slug: 'usb-c-hub', name: 'USB-C Hub 7-in-1', description: 'Expand your laptop with HDMI 4K, USB-A × 3, SD/microSD, and 100W PD pass-through charging.', price: 65, images: img('usbc-hub'), category: 'tech-electronics', vendor: { name: T, phone: '020 456 7890', email: 'techconnect@aces.edu' }, createdAt: '2026-02-05', stock: 14 },
  { id: 't4', slug: 'mechanical-keyboard', name: 'Mechanical Keyboard', description: 'Compact 75% mechanical keyboard with hot-swappable switches and per-key RGB lighting.', price: 110, images: img('mechanical-keyboard'), category: 'tech-electronics', vendor: { name: GU, phone: '024 567 8901', email: 'gadgetguru@aces.edu' }, createdAt: '2026-02-12', stock: 7, colors: [{ name: 'Black', hex: '#111111', images: img('mechanical-keyboard') }, { name: 'White', hex: '#F5F5F5', images: img('mechanical-keyboard') }] },
  { id: 't5', slug: 'laptop-stand', name: 'Adjustable Laptop Stand', description: 'Ergonomic aluminium laptop stand with adjustable height and angle. Folds flat for your bag.', price: 55, images: img('laptop-stand'), category: 'tech-electronics', vendor: { name: T, phone: '020 456 7890', email: 'techconnect@aces.edu' }, createdAt: '2026-02-18', stock: 20 },
  { id: 't6', slug: 'webcam-1080p', name: '1080p Webcam', description: 'Full HD webcam with built-in ring light and noise-cancelling microphone. Plug-and-play USB.', price: 70, images: img('webcam-hd'), category: 'tech-electronics', vendor: { name: GU, phone: '024 567 8901', email: 'gadgetguru@aces.edu' }, createdAt: '2026-03-01', stock: 9 },
  { id: 't7', slug: 'smartwatch-band', name: 'Smartwatch Band', description: 'Premium silicone replacement band compatible with Apple Watch and Samsung Galaxy Watch. Multiple colours.', price: 25, images: img('smartwatch-band'), category: 'tech-electronics', vendor: { name: T, phone: '020 456 7890', email: 'techconnect@aces.edu' }, createdAt: '2026-03-10', stock: 25, colors: [{ name: 'Black', hex: '#111111', images: img('smartwatch-band') }, { name: 'Blue', hex: '#3B82F6', images: img('smartwatch-band') }, { name: 'Red', hex: '#EF4444', images: img('smartwatch-band') }] },
  { id: 't8', slug: 'bluetooth-speaker', name: 'Portable Bluetooth Speaker', description: 'Waterproof portable speaker with 360° sound, 12-hour battery, and a built-in carabiner.', price: 60, images: img('bt-speaker'), category: 'tech-electronics', vendor: { name: GU, phone: '024 567 8901', email: 'gadgetguru@aces.edu' }, createdAt: '2026-03-18', stock: 11 },
  { id: 't9', slug: 'xl-mouse-pad', name: 'Gaming Mouse Pad XL', description: '900 × 400 mm extended mouse pad with stitched edges and a smooth microfiber surface.', price: 28, images: img('mousepad-xl'), category: 'tech-electronics', vendor: { name: T, phone: '020 456 7890', email: 'techconnect@aces.edu' }, createdAt: '2026-03-25', stock: 30 },
  { id: 't10', slug: 'hdmi-cable-pack', name: 'HDMI Cable Pack', description: 'Pack of 2 premium HDMI 2.1 cables (1.5m and 3m) supporting 4K@120Hz and eARC.', price: 22, images: img('hdmi-pack'), category: 'tech-electronics', vendor: { name: GU, phone: '024 567 8901', email: 'gadgetguru@aces.edu' }, createdAt: '2026-04-02', stock: 40 },
